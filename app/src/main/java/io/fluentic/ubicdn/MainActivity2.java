...
import io.fluentic.ubicdn.fragments.MainFragment;
import io.fluentic.ubicdn.fragments.list.kiosk.KioskFragment;
//import org.schabi.newpipe.fragments.list.search.SearchFragment;
//import org.schabi.newpipe.history.HistoryListener;
import io.fluentic.ubicdn.util.Constants;
import io.fluentic.ubicdn.util.NavigationHelper;
import io.fluentic.ubicdn.util.StateSaver;
import io.fluentic.ubicdn.util.ThemeHelper;

public class MainActivity2 extends AppCompatActivity /*implements HistoryListener*/ {
       ...
       /* if (getIntent() != null && getIntent().hasExtra(Constants.KEY_LINK_TYPE)) {
        ...
        try {
            getSupportFragmentManager().beginTransaction()
                    ...
                    .replace(R.id.fragment_holder, KioskFragment.getInstance(MainFragment.FALLBACK_SERVICE_ID, MainFragment.FALLBACK_KIOSK_ID))
                    .addToBackStack(null)
                    .commit();
        }catch (Exception e){}
    }
