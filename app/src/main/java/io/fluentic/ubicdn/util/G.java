...
import io.fluentic.ubicdn.net.wifi.WifiDirectServiceDiscovery;
import io.fluentic.ubicdn.net.wifi.WifiLink;
...
public class G {
  ...
  private static final List<String> btTags = new ArrayList<>(Arrays.asList("BtPort","BluetoothAdapter", "BluetoothLeScanner","BluetoothLeAdvertiser","BleAdvertiser","BtLink","BleScanner","BTTransport","BtServiceDiscovery","BtServer","BtSwitcherDumb"));

  private static final List<String> wifiTags = new ArrayList<>(Arrays.asList("WifiLink", "WifiDirectHotSpot","WifiDirectServiceDiscovery",WifiDirectServiceDiscovery.class.getName(),WifiLink.class.getName()));

  /** Tag used in log output to identify NFD Service. */
  private static final String TAG = "UbiCDN";
