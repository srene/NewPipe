...
import io.fluentic.ubicdn.MainActivity2;
import io.fluentic.ubicdn.extractor.Info;
import io.fluentic.ubicdn.extractor.ListExtractor.NextItemsResult;
import io.fluentic.ubicdn.extractor.NewPipe;
import io.fluentic.ubicdn.extractor.channel.ChannelInfo;
import io.fluentic.ubicdn.extractor.kiosk.KioskInfo;
import io.fluentic.ubicdn.extractor.playlist.PlaylistInfo;
import io.fluentic.ubicdn.extractor.search.SearchEngine;
import io.fluentic.ubicdn.extractor.search.SearchResult;
...
public final class ExtractorHelper {
    ...
    public static Single<KioskInfo> getKioskInfo(final int serviceId, final String url, final String contentCountry, boolean forceLoad) {
        Log.d(TAG,"Get kiosk info "+serviceId+" "+url+" "+contentCountry+" "+forceLoad);
