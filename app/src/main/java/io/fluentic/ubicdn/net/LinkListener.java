...
package io.fluentic.ubicdn.net;
...
public interface LinkListener
{
	 ...
	 */
	//void transportNeedsActivity(ActivityCallback callback);
	 ...
	 */
	void btLinkConnected(Link link);
	 ...
	 */
	void btLinkDisconnected(Link link);
	...
	void peerDiscovered(String name, String address);
}
