...
package io.fluentic.ubicdn.net.bluetooth.discovery.ble.detector;
...
{
	private static final String TAG="BleLollipopDetector";
	...
	public void startScan()
	{
		...
		if(scanner == null)
		{
			G.Log(TAG,"ble central failed to get BluetoothLeScanner instance");
		...
		this.scanCallback = new ScanCallback()
		{
			...
			public void onScanFailed(int errorCode)
			{
				...
				G.Log(TAG,"ble central scan failed: "+errorString);
		...
		{
			G.Log(TAG,"ble scan failed: illegal adapter state");
