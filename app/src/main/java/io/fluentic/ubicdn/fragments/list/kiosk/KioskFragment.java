package io.fluentic.ubicdn.fragments.list.kiosk;
...
import io.fluentic.ubicdn.extractor.kiosk.KioskInfo;
import io.fluentic.ubicdn.fragments.list.BaseListInfoFragment;
//import org.schabi.newpipe.report.UserAction;
import io.fluentic.ubicdn.util.ExtractorHelper;
import io.fluentic.ubicdn.util.KioskTranslator;
...
public class KioskFragment extends BaseListInfoFragment<KioskInfo> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_kiosk, container, true);
    }
