package io.fluentic.ubicdn.fragments.detail;
...
import io.fluentic.ubicdn.extractor.services.youtube.YoutubeStreamExtractor;
import io.fluentic.ubicdn.extractor.stream.AudioStream;
import io.fluentic.ubicdn.extractor.stream.StreamInfo;
import io.fluentic.ubicdn.extractor.stream.StreamInfoItem;
import io.fluentic.ubicdn.extractor.stream.VideoStream;
import io.fluentic.ubicdn.fragments.BackPressable;
import io.fluentic.ubicdn.fragments.BaseStateFragment;
...
import io.fluentic.ubicdn.util.ExtractorHelper;
import io.fluentic.ubicdn.util.InfoCache;
import io.fluentic.ubicdn.util.ListHelper;
import io.fluentic.ubicdn.util.Localization;
import io.fluentic.ubicdn.util.NavigationHelper;
...
import static io.fluentic.ubicdn.util.AnimationUtils.animateView;
...
public class VideoDetailFragment extends BaseStateFragment<StreamInfo> implements BackPressable, SharedPreferences.OnSharedPreferenceChangeListener, View.OnClickListener, View.OnLongClickListener {
   ...
   // private boolean wasRelatedStreamsExpanded = false;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        return false; //return (!isLoading.get() && actionBarHandler.onItemSelected(item)) || super.onOptionsItemSelected(item);
    }
