...
import io.fluentic.ubicdn.fragments.detail.helper.AudioReactor;
import io.fluentic.ubicdn.fragments.detail.helper.CacheFactory;
import io.fluentic.ubicdn.fragments.detail.helper.LoadController;
import io.fluentic.ubicdn.fragments.detail.playback.MediaSourceManager;
import io.fluentic.ubicdn.fragments.detail.playback.PlaybackListener;
import io.fluentic.ubicdn.playlist.PlayQueue;
import io.fluentic.ubicdn.playlist.PlayQueueAdapter;
...
import static io.fluentic.ubicdn.fragments.detail.helper.PlayerHelper.getTimeString;
...
public abstract class BasePlayer implements Player.EventListener, PlaybackListener {
     ...
     * If the current {@link Timeline.Window window} is valid,
