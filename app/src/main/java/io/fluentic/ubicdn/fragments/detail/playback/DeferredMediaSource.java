 ...
 * {@link io.fluentic.ubicdn.extractor.stream.StreamInfoItem} is converted into
 * {@link StreamInfo}. Once conversion is complete,
...
public final class DeferredMediaSource implements MediaSource {
    ...
    public interface Callback {
        /**
         * Player-specific {@link MediaSource} resolution
     ...
     * like any other native {@link MediaSource}.
     *
     ...
     * {@link MediaSource#prepareSource(ExoPlayer, boolean, Listener) prepareSource}.
     * */
    @Override
     ...
     *
     * This method is called when the parent {@link MediaSource}
     ...
     * This method should not set null the internal {@link MediaSource}.
     * */
    @Override
